...
/**
 * Implementa MustVerifyEmail para activar el flujo nativo de verificación de
 * correo de Laravel (envío de la notificación, hash firmado, etc.). El
 * bloqueo de inicio de sesión hasta verificar se aplica en AuthController.
 */
